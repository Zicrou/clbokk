...
<html>
    <head>
        ...
        <title>Administration  Prive</title>
        ...
        <div class="wrapper-page">
            <div class="panel panel-color panel-primary panel-pages">
                <div class="panel-heading bg-img"> 
                    ...
                    <h3 class="text-center m-t-10 text-white">Accés à PETTAO </h3>
                </div> 


                <div class="panel-body">
<!--                <form class="form-horizontal m-t-20" action="index.html">
-->                <form id="sign_in" method="POST" class="form-horizontal m-t-20" action="verif-connexion">   
                    ...
                    <div class="form-group m-t-30">
                        <div class="col-sm-7">
                            <a href="recoverpw.html"><i class="fa fa-lock m-r-5"></i> Mot de passe oublié?</a>
                        </div>
