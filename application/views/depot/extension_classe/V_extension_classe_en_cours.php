                    ...
                    <tbody>
                        <?php foreach ($all_data as $value) { ?>
                                        <tr>
                                            ...
                                            <td style="width:30px;">
                                            <a  href='C_depot\detail_extension_classe\<?php echo $value->id_depot; ?>' id='<?php echo $value->id_depot; ?>'   class=" detail btn-role btn btn-inverse waves-effect waves-light btn-xs m-b-5">
