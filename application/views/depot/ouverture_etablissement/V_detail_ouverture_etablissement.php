                        ...
                        <div class="panel panel-border panel-purple">
                                    <div class="panel-heading"> 
                                        <h3 class="panel-title"></h3> 
                                                    ...
                                                    <br>
                                                    <form action='C_depot/save_depot_ouverture_etablissement' method="post" id='form_circuit_depot'  class='form-inline'>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-group m-l-10" >
                                                                <label class="sr-only" for='numero_arrete'>recepisse: </label>&nbsp;<input type='text' name='numero_recepisse' placeholder="Numero recepisse"  class="form-control recepisse_control " required>
                                                            </div>&nbsp;
                                                            <div class="form-group m-l-10">
                                                    ...
                                                    <?php if($this->session->lfc_jafr12_s['id_type_structure']!=2)
                                                        {
                                                            echo "<script>$('.recepisse_control').hide();</script>";
                                                        }
